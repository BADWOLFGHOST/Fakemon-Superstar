...
module MessageConfig
  ...
  FONT_NAME                = "Fusion Pixel 12px Monospaced zh_hans"
  FONT_SIZE                = 27
  FONT_Y_OFFSET            = 8
  SMALL_FONT_NAME          = "Fusion Pixel 12px Monospaced zh_hans"
  SMALL_FONT_SIZE          = 21
  SMALL_FONT_Y_OFFSET      = 8
  NARROW_FONT_NAME         = "Fusion Pixel 12px Monospaced zh_hans"
  NARROW_FONT_SIZE         = 27
