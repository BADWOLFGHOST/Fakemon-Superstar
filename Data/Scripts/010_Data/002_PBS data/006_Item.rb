  ...
  class Item
    ...
    def self.editor_properties
      ...
      return [
        ...
        ["PortionName",       ItemNameProperty,                        _INTL("一份此道具时显示的名称。")],
        ["PortionNamePlural", ItemNameProperty,                        _INTL("多份此道具时显示的名称。")],
        ["Pocket",            PocketProperty,                          _INTL("存放此道具的口袋。")],
        ["Price",             LimitProperty.new(Settings::MAX_MONEY),  _INTL("此道具的购价。")],
        ["SellPrice",         LimitProperty2.new(Settings::MAX_MONEY), _INTL("此道具的售价。如果未填写，则为购价的一半。")],
        ["BPPrice",           LimitProperty.new(Settings::MAX_BATTLE_POINTS), _INTL("此道具用对战点数（BP）购买时的价格。")],
        ["FieldUse",          EnumProperty.new(field_use_array),       _INTL("此道具在对战外使用的方式。")],
        ["BattleUse",         EnumProperty.new(battle_use_array),      _INTL("此道具在对战时使用的方式。")],
        ["Flags",             StringListProperty,                      _INTL("将道具分组的某些英文单词/短语。")],
        ["Consumable",        BooleanProperty,                         _INTL("此道具使用后是否会被消耗。")],
        ["ShowQuantity",      BooleanProperty,                         _INTL("是否在背包里显示此道具的数量。")],
        ["Move",              MoveProperty,                            _INTL("使用此HM/TM/TR学会的招式。")],
