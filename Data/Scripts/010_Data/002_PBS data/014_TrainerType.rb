  ...
  class TrainerType
    ...
    def self.editor_properties
      ...
      return [
        ...
        ["BaseMoney",  LimitProperty.new(9999),        _INTL("玩家赢取的钱为此数乘于训练家所有精灵中等级最高的那只的等级。")],
        ["SkillLevel", LimitProperty2.new(9999),       _INTL("此训练家类型的招式水平。")],
        ["Flags",      StringListProperty,             _INTL("用于让此训练家类型的行为与其他类型不同的英文单词/短语。")],
        ["IntroBGM",   BGMProperty,                    _INTL("与此训练家类型对战前播放的BGM。")],
        ["BattleBGM",  BGMProperty,                    _INTL("与此训练家类型对战时播放的BGM。")],
        ["VictoryBGM", BGMProperty,                    _INTL("战胜此训练家类型后播放的BGM。")]
      ]
    end
