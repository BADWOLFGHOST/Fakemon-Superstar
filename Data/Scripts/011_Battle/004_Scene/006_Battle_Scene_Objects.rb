...
class Battle::Scene::PokemonDataBox < Sprite
  ...
  MALE_BASE_COLOR         = Color.new(255, 213, 8)
  MALE_SHADOW_COLOR       = Color.new(213, 131, 8)
  FEMALE_BASE_COLOR       = Color.new(189, 222, 230)
  FEMALE_SHADOW_COLOR     = Color.new(106, 148, 148)
...
#    pbSetSmallFont(@hpNumbers.bitmap)
  ...
  def draw_gender
    ...
    gender_text  = (gender == 0) ? _INTL("耀") : _INTL("辉")
