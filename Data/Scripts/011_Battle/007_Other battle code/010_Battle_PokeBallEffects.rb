...
Battle::PokeBallEffects::ModifyCatchRate.add(:MIXBALLNG, proc { |ball, catchRate, battle, battler|
  multiplier = (Settings::NEW_POKE_BALL_CATCH_RATES) ? 3.5 : 3
  catchRate *= multiplier if battler.pbHasType?(:NORMAL) || battler.pbHasType?(:GHOST)
  next catchRate
})

Battle::PokeBallEffects::ModifyCatchRate.add(:MIXBALLFD, proc { |ball, catchRate, battle, battler|
  multiplier = (Settings::NEW_POKE_BALL_CATCH_RATES) ? 3.5 : 3
  catchRate *= multiplier if battler.pbHasType?(:FLYING) || battler.pbHasType?(:DRAGON)
  next catchRate
})

Battle::PokeBallEffects::ModifyCatchRate.add(:MIXBALLFF, proc { |ball, catchRate, battle, battler|
  multiplier = (Settings::NEW_POKE_BALL_CATCH_RATES) ? 3.5 : 3
  catchRate *= multiplier if battler.pbHasType?(:FIRE) || battler.pbHasType?(:FIGHTING)
  next catchRate
})

Battle::PokeBallEffects::ModifyCatchRate.add(:MIXBALLPF, proc { |ball, catchRate, battle, battler|
  multiplier = (Settings::NEW_POKE_BALL_CATCH_RATES) ? 3.5 : 3
  catchRate *= multiplier if battler.pbHasType?(:PSYCHIC) || battler.pbHasType?(:FAIRY)
  next catchRate
})

Battle::PokeBallEffects::ModifyCatchRate.add(:MIXBALLWI, proc { |ball, catchRate, battle, battler|
  multiplier = (Settings::NEW_POKE_BALL_CATCH_RATES) ? 3.5 : 3
  catchRate *= multiplier if battler.pbHasType?(:WATER) || battler.pbHasType?(:ICE)
  next catchRate
})

Battle::PokeBallEffects::ModifyCatchRate.add(:MIXBALLBG, proc { |ball, catchRate, battle, battler|
  multiplier = (Settings::NEW_POKE_BALL_CATCH_RATES) ? 3.5 : 3
  catchRate *= multiplier if battler.pbHasType?(:BUG) || battler.pbHasType?(:GRASS)
  next catchRate
})

Battle::PokeBallEffects::ModifyCatchRate.add(:MIXBALLES, proc { |ball, catchRate, battle, battler|
  multiplier = (Settings::NEW_POKE_BALL_CATCH_RATES) ? 3.5 : 3
  catchRate *= multiplier if battler.pbHasType?(:ELECTRIC) || battler.pbHasType?(:STEEL)
  next catchRate
})

Battle::PokeBallEffects::ModifyCatchRate.add(:MIXBALLRG, proc { |ball, catchRate, battle, battler|
  multiplier = (Settings::NEW_POKE_BALL_CATCH_RATES) ? 3.5 : 3
  catchRate *= multiplier if battler.pbHasType?(:ROCK) || battler.pbHasType?(:GROUND)
  next catchRate
})

Battle::PokeBallEffects::ModifyCatchRate.add(:MIXBALLDP, proc { |ball, catchRate, battle, battler|
  multiplier = (Settings::NEW_POKE_BALL_CATCH_RATES) ? 3.5 : 3
  catchRate *= multiplier if battler.pbHasType?(:DARK) || battler.pbHasType?(:POISON)
  next catchRate
})
#===============================================================================
# OnCatch
