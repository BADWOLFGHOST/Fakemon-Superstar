...
class PokemonStorageScene
  ...
  def pbUpdateOverlay(selection, party = nil)
    ...
    if !pokemon.egg?
      imagepos = []
      if pokemon.male?
        textstrings.push([_INTL("耀"), 148, 14, :left, Color.new(255, 213, 8), Color.new(213, 131, 8)])
      elsif pokemon.female?
        textstrings.push([_INTL("辉"), 148, 14, :left, Color.new(189, 222, 230), Color.new(106, 148, 148)])
      end
