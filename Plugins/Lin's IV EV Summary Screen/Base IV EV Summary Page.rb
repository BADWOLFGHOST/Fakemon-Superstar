...
class PokemonSummary_Scene
  def drawPageBaseIVEV
    ...
    textpos = [
      [_INTL("SS"), 370, 94, :center, base, shadow],
      ...
      [_INTL("攻击"), 248, 158, :left, base, statshadows[:ATTACK]],
      ...
      [_INTL("防御"), 248, 190, :left, base, statshadows[:DEFENSE]],
      ...
      [_INTL("特攻"), 248, 222, :left, base, statshadows[:SPECIAL_ATTACK]],
      ...
      [_INTL("特防"), 248, 254, :left, base, statshadows[:SPECIAL_DEFENSE]],
      ...
      [_INTL("速度"), 248, 286, :left, base, statshadows[:SPEED]],
